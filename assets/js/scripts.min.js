...
}},animation:{end:{WebkitAnimation:"webkitAnimationEnd",MozAnimation:"animationend",OAnimation:"oAnimationEnd",animation:"animationend"}}},u={csstransforms:function(){return!!r("transform")},csstransforms3d:function(){return!!r("perspective")},csstransitions:function(){return!!r("transition")},cssanimations:function(){return!!r("animation")}};u.csstransitions()&&(t.support.transition=new String(s("transition")),t.support.transition.end=l.transition.end[t.support.transition]),u.cssanimations()&&(t.support.animation=new String(s("animation")),t.support.animation.end=l.animation.end[t.support.animation]),u.csstransforms()&&(t.support.transform=new String(s("transform")),t.support.transform3d=u.csstransforms3d())}(window.Zepto||window.jQuery,window,document),$(document).ready(function(){function t(t){for(var e=t.target.id,n=0;n<s.length;n++)e===s[n]?(document.getElementById(s[n]).classList.add("active1"),document.getElementById(o[n]).style.display="block"):(document.getElementById(s[n]).classList.remove("active1"),document.getElementById(o[n]).style.display="none")}function e(t,e){function n(){i>=90?clearInterval(r):(i++,t.style.width=i+"%",e&&(e.innerHTML=i+"%"))}var i=10,r=setInterval(n,10)}function n(t){var e=t.getBoundingClientRect(),n=document.documentElement.clientHeight,i=e.top>0&&e.top<n,r=e.bottom<n&&e.bottom>0;return i&&r}function i(){for(var t=document.getElementById("html5"),i=t.getAttribute("sean"),r=0;r<1;r++)if(i&&n(t)){for(var r=0;r<c.length;r++)e(c[r],h[r]);t.setAttribute("sean","")}}var r=$(".owl-carousel");r.owlCarousel({loop:!0,items:1,dotsContainer:".points"}),$(".customNextBtn").click(function(){r.trigger("next.owl.carousel",[800])}),$(".customPrevBtn").click(function(){r.trigger("prev.owl.carousel",[800])}),$(".toggle-mnu").click(function(){return $(this).toggleClass("on"),$(".hidden-mnu").slideToggle(),!1});for(var s=new Array("client1","client2","client3"),o=new Array("abtclient1","abtclient2","abtclient3"),a=0;a<s.length;a++)document.getElementById(s[a]).onclick=t;for(var l=document.querySelectorAll('[href^="#nav"]'),u=.2,a=0;a<l.length;a++)l[a].addEventListener("click",function(t){function e(t){null===s&&(s=t);var o=t-s,a=r<0?Math.max(n-o/u,n+r):Math.min(n+o/u,n+r);window.scrollTo(0,a),a!=n+r?requestAnimationFrame(e):location.hash=i}t.preventDefault();var n=window.pageYOffset,i=this.href.replace(/[^#]*(.*)/,"$1"),r=document.querySelector(i).getBoundingClientRect().top,s=null;requestAnimationFrame(e)},!1);var c=document.getElementsByClassName("myProgress"),h=document.getElementsByClassName("procent");document.getElementById("navproskills");window.onscroll=i,i()});